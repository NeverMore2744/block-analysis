...
simplePdf("../figures/f5_f6_f7_num_ali", mywidth, myheight, T);
print(myplot(ali_attrs, 5, 32, 1000, seq(0, 1000, 250), c(seq(0, 25, 5), 31)));
simplePdf("../figures/f5_f6_f7_num_msr", mywidth, myheight, T);
print(myplot(msr_attrs, 5, 7, 36, seq(0, 40, 10), seq(0, 7, 1)));
simplePdf("../figures/f5_f6_f7_num_tc", mywidth, myheight, T);
print(myplot(tc_attrs, 5, 9, 5000, seq(0, 5000, 1000), seq(0, 9, 1)));

################# Time analysis

ali_attr <- read.table(paste0(dirname, "b5_b6_b7_time_ali.data"), 
    header = T, stringsAsFactors = F);
msr_attr <- read.table(paste0(dirname, "b5_b6_b7_time_msr.data"), 
    header = T, stringsAsFactors = F);
tc_attr <- read.table(paste0(dirname, "b5_b6_b7_time_tc.data"), 
    header = T, stringsAsFactors = F);
...
simplePdf("../figures/f5_f6_f7_time_ali", mywidth, myheight, T);
print(myplot(ali_attr, c(seq(0, 25, 5), 31), c(0, 31)));
simplePdf("../figures/f5_f6_f7_time_msr", mywidth, myheight, T);
print(myplot(msr_attr, seq(0, 7, 1), c(0, 7)));
simplePdf("../figures/f5_f6_f7_time_tc", mywidth, myheight, T);
